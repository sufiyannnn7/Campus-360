...
export const UPCOMING_EVENTS_DATA: UpcomingEventItem[] = [
  ...
  },
  {
    ...
    date: "Aug 28, 2026",
    startDatetime: "2026-08-28T16:30:00Z",
  ...
  {
    id: 11,
    title: "Web3 & Smart Contract Developer Bootcamp",
    date: "Aug 04, 2026",
  ...
  {
    id: 12,
    title: "Generative AI & LLM Hands-on Hackathon",
    date: "Aug 07, 2026",
    startDatetime: "2026-08-07T11:00:00Z",
    time: "11:00 AM - 05:00 PM",
    venue: "Tech Lab 1 (Engineering Wing)",
    category: "Technical",
    organizer: "Future Tech Club",
    organizerLogo: "https://api.dicebear.com/9.x/initials/svg?seed=FutureTech&backgroundColor=6366f1",
    status: "Filling Fast",
  ...
  {
    id: 13,
    title: "Inter-Departmental Cricket Tournament Finals",
    date: "Aug 10, 2026",
    startDatetime: "2026-08-10T09:00:00Z",
    time: "09:00 AM - 04:00 PM",
    venue: "College Sports Ground & Athletics Arena",
    category: "Sports",
    organizer: "NKOCET Sports Council",
    organizerLogo: "https://api.dicebear.com/9.x/initials/svg?seed=Sports&backgroundColor=16a34a",
    status: "Open",
    bannerUrl: "https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?w=800&auto=format&fit=crop&q=80",
    seatsLeft: 100,
  },
  {
    id: 7,
  ...
  {
    id: 14,
    title: "Freedom Eve Cultural Night & Music Fest",
    date: "Aug 14, 2026",
    startDatetime: "2026-08-14T17:00:00Z",
    time: "05:00 PM - 09:30 PM",
    venue: "College Main Auditorium",
    category: "Cultural",
    organizer: "Cultural Association",
    organizerLogo: "https://api.dicebear.com/9.x/initials/svg?seed=Cultural&backgroundColor=d97706",
    status: "Filling Fast",
  ...
  },
  {
    ...
    date: "Aug 15, 2026",
    startDatetime: "2026-08-15T08:00:00Z",
    time: "08:00 AM - 10:30 AM",
    venue: "Main Administrative Quadrangle",
    category: "Social Service",
    organizer: "Student Council",
    organizerLogo: "https://api.dicebear.com/9.x/initials/svg?seed=Council&backgroundColor=2563eb",
    status: "Open",
    bannerUrl: "https://images.unsplash.com/photo-1532375810709-75b1da00537c?w=800&auto=format&fit=crop&q=80",
    seatsLeft: 300,
  },
  {
    id: 8,
    ...
    date: "Aug 18, 2026",
    startDatetime: "2026-08-18T11:00:00Z",
  ...
  {
    id: 16,
    title: "UI/UX Figma Design Sprint & Prototype Challenge",
    date: "Sep 02, 2026",
    startDatetime: "2026-09-02T10:00:00Z",
    time: "10:00 AM - 04:00 PM",
    venue: "CSE Computer Center Lab 3",
    category: "Arts",
    organizer: "CSESA",
    organizerLogo: "https://api.dicebear.com/9.x/initials/svg?seed=CSESA&backgroundColor=3b82f6",
    status: "Open",
    bannerUrl: "https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=800&auto=format&fit=crop&q=80",
    seatsLeft: 30,
  },
  {
    id: 6,
...
export const MINI_CALENDAR_EVENTS: MiniCalendarEvent[] = [
  { day: 4, title: "Web3 Developer Bootcamp", category: "Technical", time: "10:00 AM", eventId: 11 },
  { day: 7, title: "Generative AI Hackathon", category: "Technical", time: "11:00 AM", eventId: 12 },
  { day: 10, title: "Cricket Finals", category: "Sports", time: "09:00 AM", eventId: 13 },
  { day: 12, title: "Team Avengineers SAE Vehicle Showcase", category: "Technical", time: "10:00 AM", eventId: 7 },
  { day: 14, title: "Freedom Eve Cultural Night", category: "Cultural", time: "05:00 PM", eventId: 14 },
  { day: 15, title: "Independence Day Parade", category: "Social Service", time: "08:00 AM", eventId: 15 },
  ...
  { day: 28, title: "Rotaract Club Youth Orientation", category: "Social Service", time: "04:30 PM", eventId: 5 },
...
export const LATEST_NEWS_DATA: LatestNewsItem[] = [
  ...
  {
    id: 2,
    title: "Triple Launch Milestone: Future Tech Club & English Club Inaugurated on Aug 22",
    category: "Campus News",
    date: "Aug 22, 2026",
    excerpt: "NKOCET celebrated a grand joint inauguration ceremony at the College Seminar Hall, unleashing new opportunities in AI, literary arts, and innovation.",
